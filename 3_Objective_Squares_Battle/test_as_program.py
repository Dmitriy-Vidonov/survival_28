...
N = 19 # число строк матрицы
M = 19 # число элементов в строке - число столбцов

def_massiv = [1,1, 19,19, 1,10, 19,10, 10,1, 10,19, 10,10, 1,19, 19,1] # наш массив, который мы передаем из функуции. чет - в x, нечет - в y
