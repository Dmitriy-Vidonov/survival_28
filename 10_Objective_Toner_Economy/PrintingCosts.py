...
def PrintingCosts(Line: str) -> int:
    ...
    sum = 0
    letter = list(Line) #преобразовали строку в массив символов
    toner_consume.toner = list(map(toner_consume, letter)) #применили функцию к кажд. эл-ту

    for x in toner_consume.toner:
        sum += x
